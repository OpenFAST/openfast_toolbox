...
import openfast_toolbox.converters.beamdyn as bd
...
class Test(unittest.TestCase):
    ...
    def test_BAR0(self):
        ...
        df_c2, df_st = bd.beamDynToHawc2(BD_mainfile, BD_bladefile, H2_htcfile_new, H2_stfile, 'blade1', FPM=True, verbose=False)
