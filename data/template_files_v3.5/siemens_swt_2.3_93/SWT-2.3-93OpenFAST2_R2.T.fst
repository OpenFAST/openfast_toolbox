------- OpenFAST v3.5.* INPUT FILE ------------------------------------------------
Siemens SWT 2.3-93. Model updated by rthedin, 08-2024
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- INPUT FILES ---------------------------------------------
"SWT-2.3-93_ED.dat"    EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
"unused"               BDBldFile(1) - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"               BDBldFile(2) - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"               BDBldFile(3) - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"SWT-2.3-93_IW.dat"    InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"SWT-2.3-93_AD.dat"    AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"SWT-2.3-93_SD_R2.dat" ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
